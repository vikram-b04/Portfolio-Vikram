  ...
  return (
    <div>
        <header className='header'>
          ...
          <label htmlFor="" className='menuicon'>
          ...
          {/* <nav className='nav'>
            <div className='navbar'>
              <a href="" className='ii'>
                <img className='logo' src={require("./images/v logo.png")} alt="" />
              </a>
              <div className='mobile-menu'>
                <button className='menubtn'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-5 w-5"><path fill-rule="evenodd" d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z" clip-rule="evenodd"></path></svg>
                </button>
              ...
              <div className='menu'>
                <ul className='ul'>
                  ...
                  <li>
                    <a className='a' href="">About Me</a>
                  </li>
                  <li>
                    <a className='a' href="">Skills</a>
                  </li>
                  <li>
                    <a className='a' href="">Project</a>
                  </li>
                  <li>
         ...
         {/* <div className='navbar-border pt-1'>
        <nav class="navbar navbar-expand-lg">
        <div class="container-fluid logo">
          <a class="headerlogo navbar-brand ms-lg-4" href="#"><img src={require('./images/v logo.png')} alt=""/></a>
          <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
          </button>
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto fw-medium fs-5">
              <li class="nav-item navtext">
                <a class="nav-link pe-5" aria-current="page" href="#home">Home</a>
              </li>
              <li class="nav-item navtext">
                <a class="nav-link pe-5" href="#AboutMe">About Me</a>
              </li>
              <li class="nav-item navtext">
                <a class="nav-link pe-5" href="#Skills">Skills</a>
              </li>
              <li class="nav-item navtext">
                <a class="nav-link pe-5" href="#Project">Project</a>
              </li>
              <li class="nav-item navtext">
                <a class="nav-link pe-5" href="#Contact">Contact</a>
              </li>
            </ul>
          </div>
        </div>
